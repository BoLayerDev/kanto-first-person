...
horizon instead of empty sky; and hopping a ledge gets some weight behind
it.
...
- **Jump feel.** The engine already hops you over ledges; this gives the
  hop a crouch, a boosted arc and a damped landing settle, so it lands
  with impact instead of stopping dead.
