...
| Website showcase | Coordinator | `website/`, `.github/workflows/pages.yml`, website-only CI | Gen 1 options-menu redesign merged and published; desktop/mobile browser QA open |
